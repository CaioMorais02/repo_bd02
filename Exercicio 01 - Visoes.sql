...
SELECT * FROM VW_ANIMAIS_PROPRIETARIOS

--------------------------------------------------------------------------------

CREATE VIEW VW_CONSULTAS
AS
SELECT A.CD_ANIMAL, A.NM_ANIMAL, COUNT(C.CD_ANIMAL) AS 'TOTAL_CONSULTAS'
FROM TB_ANIMAL A INNER JOIN TB_CONSULTA C
ON (A.CD_ANIMAL = C.CD_ANIMAL)
...
AS
SELECT A.CD_ANIMAL, A.NM_ANIMAL, MAX(C.DT_CONSULTA) AS 'ULTIMA_CONSULTA'
FROM TB_ANIMAL A INNER JOIN TB_CONSULTA C
ON (A.CD_ANIMAL = C.CD_ANIMAL)
GROUP BY A.CD_ANIMAL, A.NM_ANIMAL

SELECT * FROM VW_ULTIMA_CONSULTA